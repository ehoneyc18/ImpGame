...
public:
  ...
  virtual void explode() {throw std::string("Not an exploder");}
  //virtual const ExplodingSprite* getExplosion() {throw std::string("Not an exploder");}
  virtual bool checkExplosion() const {throw std::string("Not an exploder");}
